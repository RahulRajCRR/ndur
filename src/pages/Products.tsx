        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <section className="py-8 md:py-12 lg:py-20">
            <div className="text-center max-w-3xl mx-auto">
              <h1 ref={titleRef} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 px-2">
              ...
              <div ref={contentRef} className="space-y-6 mt-8 text-left">
          ...
          {/* Coming Soon Products - Bigger Text */}
          <section className="py-16 md:py-24">
            ...
            <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 px-4 md:px-0">
              {/* Product Card 1 */}
          ...
          {/* NDÜR.AI Performance Redefined Section - Enhanced Styling */}
          <section className="py-16 md:py-24">
            <div className="bg-gradient-to-br from-[#e23636]/30 to-black/60 rounded-xl p-12 flex flex-col items-center justify-center text-center">
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white opacity-90 mb-4">NDÜR.AI</h2>
              <p className="text-xl sm:text-2xl md:text-3xl text-white/70 max-w-2xl mx-auto">Performance Redefined</p>
              <div className="mt-12 max-w-3xl mx-auto">
                <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed">
                  Our mission is to revolutionize how athletes understand their bodies and optimize their performance through cutting-edge technology and artificial intelligence.
                </p>
              </div>
              <Button className="mt-10 bg-[#e23636] hover:bg-[#e23636]/90 px-8 py-6 rounded-full text-lg">
                Join the Revolution
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </div>
